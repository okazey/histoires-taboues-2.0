# Bibliographie — Soundiata Keïta

> Bibliographie consolidée et citable. Format conseillé : Auteur, *Titre*, Éditeur, Année.

## Ouvrages

1. _Auteur_, *Titre*, Éditeur, Année. — _note (ex. transcription de l'épopée)_
...
1. _placeholder_ (illustrations du Manden, cartes de l'Empire du Mali — vérifier droits).
